...
const (
	...
	STATUS_PUSH_SUMMARY              // Push this string into client's summary. Summary is shown at the end of operation.
)
...
const (
	...
	UNDO_STATUS_PUSH_SUMMARY              // Push this string into client's summary. Summary is shown at the end of operation.
)
